    ...
    def test_filters_to_public_pages_static_html_and_pdfs(self) -> None:
        routes = (
            ...
            route(
                ...
                key="collaborators",
                source_paths=(Path("site/collaborators/index.dj"), Path("site/data/people.json")),
                output_relpath="collaborators/index.html",
                public_url="/collaborators/",
                canonical_url="https://ztatlock.net/collaborators/",
            ),
            route(
                kind="cv_index_page",
                key="cv",
            ...
            route(
                ...
                key="service",
                source_paths=(Path("site/service/index.dj"), Path("site/data/service.json")),
                output_relpath="service/index.html",
                public_url="/service/",
                canonical_url="https://ztatlock.net/service/",
            ),
            route(
        ...
        self.assertEqual(
            included,
            ["about", "collaborators", "cv", "talks", "students", "service", "teaching", "demo", "demo-html", "paper"],
        )
