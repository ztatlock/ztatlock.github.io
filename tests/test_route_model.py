...
class RouteModelTests(unittest.TestCase):
    ...
    def test_validate_routes_accepts_collaborators_index_page(self) -> None:
        routes = (
            route(
                ...
                canonical_url_value="https://ztatlock.net/collaborators/",
            ),
        )
        validate_routes(routes)
    ...
    def test_validate_routes_accepts_teaching_index_page(self) -> None:
        routes = (
            route(
                ...
                public_url="/teaching/",
                canonical_url_value="https://ztatlock.net/teaching/",
            ),
        )
        validate_routes(routes)

    def test_validate_routes_accepts_news_index_page(self) -> None:
        routes = (
            route(
                ...
                public_url="/news/",
                canonical_url_value="https://ztatlock.net/news/",
            ),
        )
        validate_routes(routes)
