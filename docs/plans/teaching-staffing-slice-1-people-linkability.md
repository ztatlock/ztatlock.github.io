...
- a narrow follow-on normalization slice has now moved the obvious seeded
  LinkedIn/GitHub fallback links into the new typed fields before teaching
  staffing schema work continues
