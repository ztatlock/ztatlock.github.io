...
- [ ] Decide the CV visiting-section heading and Ian Briggs policy together during the students CV slice so the rendered heading and inclusion rule stay consistent (`site/students/index.dj`, `site/cv/index.dj`, `docs/plans/cv-campaign.md`, `docs/plans/cv-slice-2-students-projection.md`).
