...
- [ ] Plan and implement the about-page collaborator alphabet-stats projection so the collaborator-coverage joke on `site/pages/about.dj` derives from the same projected collaborator display set as `/collaborators/`, without moving the surrounding prose out of authored Djot (`docs/plans/collaborators-campaign.md`, `site/collaborators/index.dj`, `site/pages/about.dj`).
