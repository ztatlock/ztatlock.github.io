...
- [ ] Reassess the next cross-domain CV consumer slice after the first students-backed checkpoint instead of automatically broadening into teaching, service, talks, or publications (`docs/plans/cv-campaign.md`, `docs/plans/structured-content-roadmap.md`, `site/cv/index.dj`).
