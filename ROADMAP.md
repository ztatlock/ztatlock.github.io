...
- [ ] Continue the teaching-staffing campaign with the teaching-assistant canonicalization slice so confirmed TA facts become canonical on instructor-led offerings in `site/data/teaching.json`, keyed through `site/data/people.json`, while keeping tutor handling and public staffing rendering deferred (`docs/plans/teaching-staffing-campaign.md`, `site/data/teaching.json`, `site/data/people.json`).
