...
- This root-relative default is for public page destinations only.
  Do not broaden it automatically to local asset paths such as `img/...`
  unless a slice explicitly calls for that.
